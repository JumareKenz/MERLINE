    ...
    navigator.serviceWorker.ready
      .then((reg) =>
        reg.active?.postMessage({
          type: 'warm',
          urls: ['/field', '/field/new', '/field/interview', '/field/history', '/offline.html'],
        }),
      )
      .catch(() => undefined);
  }, [userId]);
    ...
    <div className="flex min-h-[100dvh] flex-col bg-field-paper text-foreground">
      <header className="pt-safe sticky top-0 z-sticky bg-navy text-white shadow-[0_1px_0_hsl(0_0%_100%/0.06)]">
        <div className="mx-auto flex h-14 max-w-xl items-center gap-3 px-4">
          <Link href="/field" className="flex items-center gap-2 rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-lemon" aria-label="Merline Field, projects">
